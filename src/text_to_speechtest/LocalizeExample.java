...
public class LocalizeExample extends JPanel
    ...
    public LocalizeExample() {        
        ...
        rb = ResourceBundle.getBundle("text_to_speechtest.messages", locale);
    ...
    public void setUILanguage() {        
        rb = ResourceBundle.getBundle("text_to_speechtest.messages", locale);
        UIManager.put("Button.font", new Font("Vrinda", Font.PLAIN, 14));
        UIManager.put("Label.font", new Font("Vrinda", Font.PLAIN, 14));
        UIManager.put("OptionPane.font", new Font("Vrinda", Font.PLAIN, 14));
        UIManager.put("OptionPane.titleText", new Font("Vrinda", Font.PLAIN, 14));
        UIManager.put("OptionPane.titleText", rb.getString("TitleText"));
