...
class TTS_NumberPart extends JFrame implements ActionListener {
    ...
    JButton a_btn = new JButton("১");
    JButton b_btn = new JButton("২");
    JButton c_btn = new JButton("৩");
    JButton d_btn = new JButton("৪");
    JButton e_btn = new JButton("৫");
